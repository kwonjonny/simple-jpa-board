...
public class GlobalExceptionHandler {
    private static final String SECURITY_AUTHORIZATION_EXCEPTION = "인가 불가: 접근이 거부 되었습니다.";
    ...
    public <T> @NotNull ResponseEntity<APIResponseDTO<String>> createErrorResponse(
    ...
    public ResponseEntity<APIResponseDTO<String>> handleServiceException(@NotNull final ServiceException ex) {
